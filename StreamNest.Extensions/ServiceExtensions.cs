    ...
    public static class ServiceExtensions
    {
        ...
        public static void ConfigureCors(this IServiceCollection services)
        {
            services.AddCors(options =>
            {
                ...
                {
                    builder.WithOrigins("http://localhost:3001", "http://localhost:3000", "https://stream-nest-alpha.vercel.app", "http://192.168.0.101:3000","http://192.168.0.100:3000", "https://clipcloud-gamma.vercel.app")
                           .AllowAnyMethod()
                           .AllowAnyHeader()
                          .AllowCredentials();
                });
